...
### Drift Slip Physics
> A physics-driven "drift along a spline" system for an orb (or vehicle) racing along a `Path2D`:
...
> Click-and-drag for `RigidBody2D` objects: click anywhere on a body to freeze it and start

- **Files:**

### Rolling Sphere Controller
> Rolls a spherical `RigidBody3D` by applying torque derived from the cross product of "up" and

...
templates_dir = 'C:/Godot_Projects/docs/templates'
...
def get_project_tier(project_path):
    ...
    # Fallback to checking GEMINI.md or just default to standard
...
def get_default_dest(filename, project_path):
    if filename in ['GEMINI.md', 'CLAUDE.md', 'AGENTS.md', 'SETUP.md', 'README.md', 'ORGANIZE.md', 'SYNC-TEMPLATES.md']:

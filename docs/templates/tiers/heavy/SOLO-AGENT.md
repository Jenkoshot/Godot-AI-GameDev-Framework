...
by whichever agent ran (The Executor Agent here, the Architect Agent in `the Architect Agent.md`) at the end of every
...
`YYYY-MM-DD HH:MM | agent=claude|the Architect Agent | phase=<phase/step> | target_system=<system or "-"> | outcome=<short outcome>`

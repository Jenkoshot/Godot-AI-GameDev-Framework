# DOCTRINE — Design & Architectural Pillars
...
(e.g., "We do not use State Machines for UI", "Never use Singletons for combat stats")
- [Insert Constraint Here]

## Art & Audio Taste
(e.g., "16-bit pixel art only, strict NES color palette", "Lo-fi synthwave audio")
- [Insert Art/Audio Rule Here]
